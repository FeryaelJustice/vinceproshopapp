...
class KtorAdminApi(
    ...
    override suspend fun updateOrderStatus(orderId: Int, status: String) {
        val token = requireToken()
        httpClient.put(url("admin/orders/$orderId/status")) {
            applyAuthHeaders(token)
    ...
    override suspend fun inventory(): List<AdminInventoryProductDto> {
        val token = requireToken()
        return httpClient.get(url("admin/inventory")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun createInventoryProduct(
        ...
        httpClient.post(url("admin/inventory")) {
            applyAuthHeaders(token)
            setBody(content)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun updateInventoryProduct(
        ...
        httpClient.put(url("admin/inventory/$productId")) {
            applyAuthHeaders(token)
            setBody(content)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun discontinueInventoryProduct(productId: Int) {
        val token = requireToken()
        httpClient.delete(url("admin/inventory/$productId")) {
            applyAuthHeaders(token)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun stockInterestRequests(): List<AdminStockInterestRequestDto> {
        val token = requireToken()
        return httpClient.get(url("admin/inventory/stock-interest-requests")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun sizes(): List<AdminSizeDto> {
        val token = requireToken()
        return httpClient.get(url("admin/inventory/sizes")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun createSize(name: String) {
        val token = requireToken()
        httpClient.post(url("admin/inventory/sizes")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
    ...
    override suspend fun updateSize(sizeId: Int, name: String) {
        val token = requireToken()
        httpClient.put(url("admin/inventory/sizes/$sizeId")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
            setBody(AdminSizeUpsertRequestDto(name = name))
        }.body<AdminSimpleResponseDto>()
    ...
    override suspend fun deleteSize(sizeId: Int) {
        val token = requireToken()
        httpClient.delete(url("admin/inventory/sizes/$sizeId")) {
            applyAuthHeaders(token)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun categories(): List<CategoryDto> {
        val token = requireToken()
        return httpClient.get(url("admin/inventory/categories")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun createCategory(
        ...
        httpClient.post(url("admin/inventory/categories")) {
            applyAuthHeaders(token)
            setBody(content)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun updateCategory(
        ...
        httpClient.put(url("admin/inventory/categories/$id")) {
            applyAuthHeaders(token)
            setBody(content)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun deleteCategory(id: String) {
        val token = requireToken()
        httpClient.delete(url("admin/inventory/categories/$id")) {
            applyAuthHeaders(token)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun navbarConfig(): AdminNavbarConfigDto {
        val token = requireToken()
        return httpClient.get(url("admin/inventory/navbar")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun updateNavbarConfig(
        ...
        val token = requireToken()
        return httpClient.put(url("admin/inventory/navbar")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
            setBody(
    ...
    override suspend fun featured(): List<FeaturedSlideDto> {
        val token = requireToken()
        return httpClient.get(url("admin/inventory/featured")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun createFeatured(payload: AdminFeaturedUpsertRequestDto) {
        val token = requireToken()
        httpClient.post(url("admin/inventory/featured")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
            setBody(payload)
        }.body<AdminSimpleResponseDto>()
    ...
    override suspend fun updateFeatured(featuredId: Int, payload: AdminFeaturedUpsertRequestDto) {
        val token = requireToken()
        httpClient.put(url("admin/inventory/featured/$featuredId")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
            setBody(payload)
        }.body<AdminSimpleResponseDto>()
    ...
    override suspend fun deleteFeatured(featuredId: Int) {
        val token = requireToken()
        httpClient.delete(url("admin/inventory/featured/$featuredId")) {
            applyAuthHeaders(token)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    override suspend fun crossSellRules(sourceType: String): List<AdminCrossSellRuleDto> {
        val token = requireToken()
        return httpClient.get(url("admin/inventory/cross-sell/rules?source_type=$sourceType")) {
            applyAuthHeaders(token)
        }.body()
    }
    ...
    override suspend fun createCrossSellRule(payload: AdminCrossSellRuleUpsertRequestDto) {
        val token = requireToken()
        httpClient.post(url("admin/inventory/cross-sell/rules")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
            setBody(payload)
        }.body<AdminSimpleResponseDto>()
    ...
    override suspend fun updateCrossSellRule(ruleId: Int, payload: AdminCrossSellRuleUpsertRequestDto) {
        val token = requireToken()
        httpClient.put(url("admin/inventory/cross-sell/rules/$ruleId")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
            setBody(payload)
        }.body<AdminSimpleResponseDto>()
    ...
    override suspend fun deleteCrossSellRule(ruleId: Int) {
        val token = requireToken()
        httpClient.delete(url("admin/inventory/cross-sell/rules/$ruleId")) {
            applyAuthHeaders(token)
        }.body<AdminSimpleResponseDto>()
    }

    override suspend fun updateCrossSellAnalyticsControl(productId: Int, isLocked: Boolean) {
        val token = requireToken()
        httpClient.put(url("admin/inventory/cross-sell/analytics/$productId/control")) {
            applyAuthHeaders(token)
            contentType(ContentType.Application.Json)
    ...
    override suspend fun recomputeCrossSellAnalytics(productId: Int) {
        val token = requireToken()
        httpClient.post(url("admin/inventory/cross-sell/analytics/$productId/recompute")) {
            applyAuthHeaders(token)
        }.body<AdminSimpleResponseDto>()
    }
    ...
    private suspend fun requireToken(): String {
        return tokenStore.readToken()?.trim().orEmpty().ifBlank {
    ...
    private fun imagePartHeaders(
        ...
        return Headers.build {
            ...
            append(
                ...
                ContentDisposition.File.withParameter(ContentDisposition.Parameters.Name, fieldName)
