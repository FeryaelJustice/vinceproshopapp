...
interface AdminApi {
    ...
    suspend fun createInventoryProduct(payload: AdminProductUpsertRequestDto, images: List<AdminUploadImage>)
    suspend fun updateInventoryProduct(productId: Int, payload: AdminProductUpsertRequestDto, images: List<AdminUploadImage>)
    ...
    suspend fun updateSize(sizeId: Int, name: String)
    ...
    suspend fun updateNavbarConfig(rootVisibleLimit: Int, orderedRootCategoryIds: List<String>): AdminNavbarConfigDto

    suspend fun featured(): List<FeaturedSlideDto>
    suspend fun createFeatured(payload: AdminFeaturedUpsertRequestDto)
    suspend fun updateFeatured(featuredId: Int, payload: AdminFeaturedUpsertRequestDto)
    ...
    suspend fun updateCrossSellRule(ruleId: Int, payload: AdminCrossSellRuleUpsertRequestDto)
    suspend fun deleteCrossSellRule(ruleId: Int)
    suspend fun updateCrossSellAnalyticsControl(productId: Int, isLocked: Boolean)
